"""Unit tests for production module ai_ide.check.

These tests target the real implementation in
AI_IDE_v1756/AI_IDE_v1756/ai_ide/check.py.
"""
...
try:
    ...
    from AI_IDE_v1756.AI_IDE_v1756.ai_ide.check import _key_values, check
except Exception:
    # Fallback for alternative PYTHONPATH layouts
    from ai_ide.check import _key_values, check  # type: ignore
