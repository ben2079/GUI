...
try:
    ...
    from AI_IDE_v1756.AI_IDE_v1756.ai_ide.chat_completion import ChatCom  # type: ignore

try:
    from . import agents_factory  # type: ignore
except Exception:
    import ai_ide.agents_factory as agents_factory  # type: ignore
from langchain_community.document_loaders import PyPDFLoader
from ai_ide.apply_agent_prompts import _SYSTEM_PROMPT
