...
Examples:
  python -m ai_ide.embed_tool build ./project
  python -m ai_ide.embed_tool query ./project "vector store design" -k 5
  python -m ai_ide.embed_tool stats ./project
  python -m ai_ide.embed_tool dump ./project out.json
