...
import ai_ide.agent_system_prompts as agent_system_prompts
from KOPIE_chat_completion import ChatCom
import json
...
# Verwendung:
cover_letter_result = generate_cover_letter(agent_system_prompts.run_agent(), json.load(open("/home/ben/Vs_Code_Projects/Projects/GUI/AI_IDE_v1756/ai_ide/Dokumente/applicant_profile.jsonf", "r", encoding="utf-8").read()))
