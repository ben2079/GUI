...
#result = vsm_projekt.query( query="", filter_dict={'source': str(GetPath()._parent(parg = f"{__file__}") + 'AppData/VSM_1_Data/116117.de - Arzt- und Psychotherapeutensuche.pdf')}, k=k)
#print(result)
