...
try:
    ...
    if "no known parent package" in msg or "attempted relative import" in msg:
        from ALDE.ALDE.alde.chat_completion import ChatComE, ChatCompletion
    else:
        raise
try:
...
def get_history() -> Any:
    ...
    if _history_instance is None:
        try:
            ...
            from ALDE.ALDE.alde.chat_completion import ChatHistory as _CH
...
def _handle_tool_calls(agent_msg, depth: int = 0,
    ...
    try:
        ...
        from ALDE.ALDE.alde.chat_completion import ChatComE, ChatCompletion  # type: ignore
